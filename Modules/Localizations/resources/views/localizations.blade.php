...
@section('content')
    ...
    <form action="{{route('createLocalization')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="modal fade" id="createLocalization" tabindex="-1" aria-labelledby="createLocalization"
             aria-hidden="true">
    ...
    <!-- Update Localization -->
    <div class="modal fade" id="updateLocalization" tabindex="-1" aria-labelledby="updateLocalization"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
